    ...
    return (
        <div className='w-full h-20  sidebar top-0 flex items-center justify-around'>
            ...
            <div className='flex gap-4 text-lg text-white'>
                <div>
                    <div></div>
                    <i className="ri-notification-fill text-blue-300"></i>
                </div>
                <div>
                    <div></div>
                    <i className="ri-movie-fill  text-gray-500"></i>
                </div>
                <div>
                    <div></div>
                    <i className="ri-task-fill text-blue-300"></i>
                    </div>
                <div>
                    <div></div>
                    <i className="ri-inbox-fill text-blue-300"></i>
                    </div>
            </div>
